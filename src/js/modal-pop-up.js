...
export function openModal() {
  ...
  closeModalBtn.addEventListener('click', closeModalPop);
...
export function closeModalPop() {
  exerciseModal.classList.remove('open');
  closeModalBtn.removeEventListener('click', closeModalPop);
...
const outsideClick = function (event) {
  ...
  if (
    ...
    exerciseModal.classList.contains('open')
  ) {
    closeModalPop();
  }
};
